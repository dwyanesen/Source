...
public class AddFriActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tx1 = (EditText)findViewById(R.id.txt_friend_name);
        tx2 = (EditText)findViewById(R.id.txt_friend_number);
        ...
        bt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if( name.equals("") || number.equals("")) {
                    Toast.makeText(AddFriActivity.this,"没输全信息，已自动返回", Toast.LENGTH_SHORT).show();
                    finish();
                }
                else {
