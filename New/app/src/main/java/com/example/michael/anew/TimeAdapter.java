 ...
 */
    ...
    public class TimeAdapter extends BaseAdapter{
        ...
        public TimeAdapter(Context context,ArrayList<Object> newobject)
        {
            ...
            //if(convertView==null) {
                ...
                switch (type) {
                    case type_1:
                        ...
                        holder1.t_event = (TextView) convertView.findViewById(R.id.right);
                        holder1.t_week = (TextView) convertView.findViewById(R.id.left1);
                        holder1.t_day = (TextView) convertView.findViewById(R.id.left2);
